...
const marketplaceController = {
  getListings: async () => {
    const results = await axios.get(LISTINGS_URL)
  ...
  postListing: async (
    ...
    formData.append(`listing_image`, { name: `image.${ext}`, type: `image/${ext}`, uri: listing.listing_image })
    console.log(formData)
    return await axios.post(LISTINGS_URL, formData, {
      headers: {
